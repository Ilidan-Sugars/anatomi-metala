...
<div id="main-banner" class="main-banner background-lazy" data-src="<?= mix('images/main-banner.png') ?>">
  <div class="container h-100 d-flex align-items-center">
    <div class="row align-items-center">
      <div class="col-md-8">
        <h1>Строительство домов<br>в городе Кемерово</h1>
        <div class="main-banner__description">
          Наша компания предлагает широкий спектр услуг по проектированию, строительству и обустройству домов, обеспечивая высокое качество и надежность каждого объекта.
        </div>
      ...
      <div class="col-md-4">
        <img class="main-banner__home" src="<?= mix('images/main-banner-home.png') ?>" alt="">
      </div>
    </div>
  </div>
</div>
...
<section id="last-projects" class="section-top-100 section-bottom-100">
  <div class="container">
    ...
    <?= do_shortcode('[list-projects category="doma"]') ?>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
      <table class="table table-striped">
        <tbody>
          <tr>
            <td>Строительство домов из каркаса</td>
            <td>Строительство домов из газобетона</td>
          </tr>
          <tr>
            <td>Дома из газоблока</td>
            <td>Дома из арболитовых блоков</td>
          </tr>
          <tr>
            <td>Дома из силикатных блоков</td>
            <td>Дома из клееного бруса</td>
          </tr>
          <tr>
            <td>Дома из двойного бруса</td>
            <td>Дома из оцилиндрованного бревна</td>
          </tr>
          <tr>
            <td>Дома из SIP панелей</td>
            <td>Дома из ЛСТК</td>
          </tr>
          <tr>
            <td>Дома из кирпича</td>
            <td>Дома из пеноблоков</td>
          </tr>
          <tr>
            <td>Дома из керамических блоков</td>
            <td>Дома из керамзитоблоков</td>
          </tr>
          <tr>
            <td>Дома из бруса</td>
            <td>Дома из профилированного бруса</td>
          </tr>
          <tr>
            <td>Дома из строганного бруса</td>
            <td>Дома из рубленного бревна</td>
          </tr>
          <tr>
            <td>Дома из лафета</td>
            <td></td>
          </tr>
        </tbody>
      </table>
