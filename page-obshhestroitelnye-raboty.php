...
<div id="main-banner" class="main-banner background-lazy" data-src="<?= mix('images/main-banner.png') ?>">
  <div class="container h-100 d-flex align-items-center">
    <div class="row align-items-center">
      <div class="col-md-8">
        <h1>Общестроительные работы<br>в городе Кемерово</h1>
        <div class="main-banner__description">
          Компания Кемерово Монтаж Строй 142 специализируется на выполнении общестроительных работ в Кемерово. Мы предоставляем комплексные услуги, начиная от проектирования и заканчивая сдачей объекта в эксплуатацию.
        </div>
      ...
      <div class="col-md-4">
        <img class="main-banner__home" src="<?= mix('images/main-banner-obshestoenie.png') ?>" alt="">
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6 col-12 my-2">
        <div class="our-service">
          ...
          <h5 class="our-service__title">Разработка грунтов</h5>
...
<section id="last-projects" class="section-top-100 section-bottom-100">
  <div class="container">
    ...
    <?= do_shortcode('[list-projects category="obshhestroitelnye-raboty"]') ?>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
      <table class="table table-striped">
        <tbody>
          <tr>
            <td>Разработка грунтов</td>
            <td>Подготовка основания под заливку бетона</td>
          </tr>
          <tr>
            <td>Бетонные работы</td>
            <td>Возведения каркаса здания (монолитные работы, кирпичная кладка)</td>
          </tr>
          <tr>
            <td>Кровельные работы</td>
            <td>Прокладка инженерных сетей</td>
          </tr>
          <tr>
            <td>Монтаж электрооборудования</td>
            <td>Отделочные работы</td>
          </tr>
          <tr>
            <td>Монтаж металлоконструкции</td>
            <td>Благоустройство территории</td>
          </tr>
          <tr>
            <td>Асфальтобетное покрытие, тратуарная плитка, резиновое покрытие</td>
          </tr>
        </tbody>
      </table>
    </div>
